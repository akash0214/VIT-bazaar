...
test('Access profile data without being authenticated', () => __awaiter(void 0, void 0, void 0, function* () {
    const res = yield (0, supertest_1.default)(app_1.default).get('/profilec').expect(400);
    expect(res.text).toBe('Unauthorised:_NO_token_provided');
}));
// Test for successfully accessing profile data
test('Access profile data successfully', () => __awaiter(void 0, void 0, void 0, function* () {
...
test('Access profile data with an invalid token', () => __awaiter(void 0, void 0, void 0, function* () {
